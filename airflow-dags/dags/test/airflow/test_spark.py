...
--conf spark.kubernetes.container.image=cartertsai/train-spark:1.0.1 local:///spark/dags/check_spark_job.py 
"""

spark_submit_operator = BashOperator(
    task_id='check_spark_with_submit_bash_dag',
